...
public class PullAndReturn2D : MonoBehaviour
{
    public float pullDistance = 0.5f; // 뒤로 이동 거리 (X 방향 기준)
    ...
    {
        Vector3 targetPosition = originalPosition + Vector3.left * pullDistance;
        float elapsed = 0f;
